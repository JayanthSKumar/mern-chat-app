...
const GroupChatModal = ({children}) => {
    ...
    const [groupNameChat, setGroupNameChat] = useState()
    ...
    const handleSubmit = async() => {
        if(!groupNameChat || !selectedUsers){
            toast({
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody display="flex" flexDir="column" alignItems="center">
            <FormControl>
                <Input placeholder="Chat Name" mb={3} onChange={(e) => setGroupNameChat(e.target.value) } />
            </FormControl>
            <FormControl>
